                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="header">
                                        <a href="sektorusaha_tambah.php" class="btn btn-info pull-right"><i class="fa fa-plus"></i></a>
                                        ...
                                        <?php
                                            if(isset($_GET['nama'])){
                                        ?>
                                            <a href="sektorusaha.php" class="btn btn-info pull-right" style="margin-right: 8px;"><i class="fa fa-arrow-left"></i></a>
                                            <?php
                                            }
                                        ?>
