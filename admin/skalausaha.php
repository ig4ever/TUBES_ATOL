...
if(isset($_GET['datausaha'])){
    $calonpekerja = $_GET['datausaha'];
}
?>
<!doctype html>
<html lang="en">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <a href="skalausaha_tambah.php" class="btn btn-info pull-right"><i class="fa fa-plus"></i></a>
                                ...
                                if(isset($_GET['nama'])){
                                    ?>
                                    <a href="skalausaha.php" class="btn btn-info pull-right" style="margin-right: 8px;"><i class="fa fa-arrow-left"></i></a>
                                    <?php
                                }
                                ?>
                                <h4 class="title">Data Skala Usaha</h4>
                                <p class="category">List dari data skala usaha</p>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped">
                                    ...
                                    <?php
                                    if(isset($_GET['nama'])){
                                        $strQuery = "SELECT id_skala, namaskala FROM skala_usaha WHERE namaskala LIKE '%$_GET[nama]%' ORDER BY id_skala DESC";
                                    }else {
                                        $strQuery = "SELECT id_skala, namaskala FROM skala_usaha ORDER BY id_skala DESC";
                                    }
                                    $query = mysqli_query($connection, $strQuery);
                                    $i = 0;
                                    while($result = mysqli_fetch_assoc($query)){
                                        echo "<tr>";
                                        echo "<td>$result[id_skala]</td>";
                                        echo "<td>$result[namaskala]</td>";
                                        echo "<td><a href='skalausaha_edit.php?id=$result[id_skala]'>Edit</a>";
                                        echo "&nbsp;&nbsp;&nbsp;";
                                        ...
                                        <div class="modal fade " id="delete<?php echo $i;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                            <div class="modal-dialog modal-sm" role="document">
                                                <form method="POST" action="php/skalausaha_delete_proses.php">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                        ...
                                                        <div class="modal-footer">
                                                            <input type="hidden" name="id" value="<?php echo " $result[id_skala] ";?>" />
