...
if(isset($_GET['id'])) {
    $id = $_GET['id'];
    $nama = "";
    $strQuery = "SELECT id_skala, namaskala FROM skala_usaha WHERE id_skala = '$id'";
    $query = mysqli_query($connection, $strQuery);
    if($query){
        $result = mysqli_fetch_array($query, MYSQLI_ASSOC);
        $id = $result['id_skala'];
        $nama = $result['namaskala'];
    }
}
?>
<!doctype html>
...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div class="content">
            <form method="POST" action="php/skalausaha_edit_proses.php">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-3">
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control border-input" name="nama" placeholder="Nama Skala Usaha" value="<?php echo "$nama"?>"/>
                                            </div>
                                        </div>
