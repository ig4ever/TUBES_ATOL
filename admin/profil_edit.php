<?php
    ...
    $username = "";
    $password = "";
    $strQuery = "SELECT a.admin_id, a.admin_nama, l.login_id, l.login_username, l.login_password
                    FROM admin a INNER JOIN login l ON a.admin_id = l.login_id
                    WHERE a.admin_id = '$id'";
    ...
    <body>
        <div class="wrapper">
            ...
            <div class="main-panel">
                ...
                <div class="content">
                    <form method="POST" action="php/profil_edit_proses.php" enctype="multipart/form-data" >
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control border-input" name="nama" placeholder="Nama Admin"  value="<?php echo $nama;?>"/>
                                                    </div>
                                                </div>                                        
