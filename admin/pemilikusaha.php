                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="header">
                                        <a href="pemilikusaha_tambah.php" class="btn btn-info pull-right"><i class="fa fa-plus"></i></a>
                                        ...
                                        <div class="modal fade" id="search" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                            <div class="modal-dialog" role="document">
                                                <form method="GET" action="pemilikusaha.php">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                            <h4 class="modal-title" id="myModalLabel">Masukkan Nama Pemilik Usaha</h4>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                <label>Nama Pemilik Usaha</label>
                                                                <input type="text" class="form-control border-input" name="nama" placeholder="Nama Pemilik Usaha" />
                                                            </div>
                                                        </div>
                                        ...
                                        <?php
                                            if(isset($_GET['nama'])){
                                        ?>
                                            <a href="pemilikusaha.php" class="btn btn-info pull-right" style="margin-right: 8px;"><i class="fa fa-arrow-left"></i></a>
                                            <?php
                                            }
                                        ?>
                                                <h4 class="title">Data Pemilik Usaha</h4>
                                                <p class="category">List dari semua pemilik_usaha yang terdaftar</p>
                                    </div>
                                            ...
                                            <tbody>
                                                <?php
                                                    if(isset($_GET['nama'])){
                                                        ...
                                                        WHERE nama LIKE '%$_GET[nama]%' ORDER BY pemilik_usaha_id DESC";
                                                    }else {
                                                        $strQuery = "SELECT cp.pemilik_usaha_id, cp.nama, 
                                                        cp.email, k.no_Ktp, cp.alamat,
                                                        cp.tempat_lahir, cp.tanggal_lahir, cp.no_telp,
                                                        cp.keterangan, cp.photo_ktp, cp.aktifasi
                                                        FROM pemilik_usaha cp INNER JOIN login k ON cp.pemilik_usaha_id = k.login_id 
                                                        ORDER BY pemilik_usaha_id DESC";
                                                    }
                                                    $query = mysqli_query($connection, $strQuery);
                                                    $i = 0;
                                                    while($result = mysqli_fetch_assoc($query)){
                                                        echo "<tr>";
                                                        echo "<td>$result[pemilik_usaha_id]</td>";
                                                        echo "<td>$result[no_Ktp]</td>";
                                                        echo "<td>$result[nama]</td>";
                                                        echo "<td>$result[email]</td>";
                                                        echo "<td>$result[alamat]</td>";
                                                        echo "<td>$result[aktifasi]</td>";
                                                        echo "<td><a href=# data-toggle=modal data-target=#detail$i>Detail</a>";
                                                        echo "&nbsp;&nbsp;&nbsp;";
                                                        echo "<a href='pemilikusaha_edit.php?id=$result[pemilik_usaha_id]'>Edit</a>";
                                                        echo "&nbsp;&nbsp;&nbsp;";
                                                ...
                                                ?>
                                                    ...
                                                    <div class="modal fade" id="detail<?php echo $i;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                    <h4 class="modal-title" id="myModalLabel">Detail Pemilik Usaha</h4>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <b>ID</b><br/>
                                                                    <?php
                                                                        echo "$result[pemilik_usaha_id]";
                                                                    ?>
                                                                    <br/><br/>
                                                                    ...
                                                                    <?php
                                                                        echo "$result[tempat_lahir], $result[tanggal_lahir]";
                                                                    ?>
                                                                    <br/><br/>
                                                                    ...
                                                                    <b>Keterangan</b><br/>
                                                                    <?php
                                                                        echo "$result[keterangan]";                                                                    ?>
                                                                    <br/><br/>

                                                                    <b>Photo KTP</b><br/>
                                                                    <?php
                                                                        echo "<a href=../upload/cv/$result[photo_ktp] target=_blank>$result[photo_ktp]</a>";                                                                    ?>
                                                                    <br/><br/>

                                                                    <b>Status</b><br/>
                                                                    <?php
                                                                        echo "$result[aktifasi]";
                                                                    ?>
                                                                    <br/><br/>
                                                                </div>
                                                                <div class="modal-footer">
                                                    ...
                                                    <div class="modal fade " id="delete<?php echo $i;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                        <div class="modal-dialog modal-sm" role="document">
                                                            <form method="POST" action="php/pemilikusaha_delete_proses.php">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <input type="hidden" name="id" value="<?php echo " $result[pemilik_usaha_id] ";?>" />
                                                                        <input type="hidden" name="login_id" value="<?php echo " $result[pemilik_usaha_id] ";?>" />
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="copyright pull-right">
                            ...
                            </script>, made with <i class="fa fa-heart heart"></i> by <a href="#">ATOL Team</a>
                        </div>
                    </div>
                </footer>
            </div>
