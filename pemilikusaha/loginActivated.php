<?php
    ...
    $d = mysqli_query($connection,"UPDATE pemilik_usaha SET aktifasi='Aktif' WHERE kode='" . $kode . "'") or die (mysqli_error());

    if ($d) {
        echo "<script language=javascript>alert('Akun " . $username . " telah aktif');</script>";
    } else {
                ...
                <div class="container" style="opacity: .95;">
                    <div style="margin-top: 156px;">
                        <form class="form-signin" method="POST" action="php/login.php" style="border: none;">
                            ...
                            <h7 class="login-text">Login sebagai <b>Pemilik Usaha</b>.</h7>
